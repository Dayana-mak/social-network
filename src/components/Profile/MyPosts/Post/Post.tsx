...
const Post: React.FC<PropsType> = ({ text, likesCount, profile }) => {
  return (
    <Paper
      component="article"
    ...
    >
      ...
      <Typography variant="body1" mb={1}>{text}</Typography>
      <Box
        display="flex"
        alignItems="center"
        gap={0.5}
      ...
      >
        <IconButton
          ...
          size="small"
          sx={{ color: "primary.main", mr: "6px", p: 0 }}
        >
          <FavoriteBorderIcon sx={{fontSize: "24px"}} />
        </IconButton>
        <Typography variant="caption" color="text.disabled" sx={{fontSize: "14px"}}>
          {likesCount}
        </Typography>
      </Box>
    </Paper>
